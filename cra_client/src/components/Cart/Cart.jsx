...
export default function Cart() {
  const { currency, products, setCartItems, setCartItemCount, mergedCartItems, setMergedCartItems, cartOpen, setCartOpen, user, currencyExchangeRates } = useContext(AppContext);
